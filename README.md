...
旧财年收益（隐藏）：财年基准年份前两年（如基准2026年即2024年）财年年报的稀释每股收益，衡量账面上的盈利能力。
  要注意投资性收益也计入每股收益，现金流才是真实收益。
新财年收益（隐藏）：财年基准年份前一年（如基准2026年即2025年）财年年报的稀释每股收益。
  默认空，检测到该财年年报后不再为空。旧财年收益恒非空、新财年收益可能为空，
  由此判断当前已完结的最新财年：新财年收益非空即最新财年为新财年，否则为旧财年；
  股息率、派息、息增年的财年同样按此判断。
财年基准年份：存于数据库 settings 表（fiscal_year_base），首次运行时写入当前年份；
  跨年时（如2027年）自动重置，旧财年收益/新财年收益随基准年份平移。
...
- 行情：qt.gtimg.cn，每批100只返回现价、昨收、开盘、最高、最低、成交量、成交额、涨跌幅。
  ...
  周末、盘前不更新；未打开前端时无任何请求，每次100只，约0.4秒一次。
...
- FCF、FCF/股息、FCF/现价：datacenter RPT_DMSK_FN_CASHFLOW，年报经营现金流净额与购建资产支出，据此计算窄口径FCF。
